...
void AgameTaskManager::BeginPlay()
{
	...
	if (doorOpenedPointer != nullptr)
	{
		doorOpenedPointer->doorOpenedDelegate.AddDynamic(this, &AgameTaskManager::dayEnd);
	}
}
...
void AgameTaskManager::lostGame()
{
	taskList.Init(false, taskQuantity);
	tasksCompleted = false;
...
//once the door has been opened and tasks are completed, the day will end
void AgameTaskManager::dayEnd()
{
